...
@Component({
  selector: 'app-visitor-filter',
  templateUrl: './visitor-filter.component.html',
  styleUrls: ['./visitor-filter.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: fuseAnimations,
})
export class VisitorFilterComponent {
...
updateAllComplete(event, i) {
  ...
  adduserdrawerClose() {
   ...
   Select_columnName: string[] = [
      'Name', 'Email', 'Mobile No', 'Company Name', 'Profession', 'Country', 'City', 'Active'
   ];
   comparisons: string[] = ['=', '!=', '<', '>', '<=', '>='];
