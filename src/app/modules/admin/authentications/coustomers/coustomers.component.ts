...
@Component({
    ...
    styleUrls: ['./coustomers.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    animations: fuseAnimations,
})
export class CoustomersComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.customers$.subscribe((data) => {
            ...
            console.log(this.recentTransactionsDataSource, 'customer');
        });
    ...
    newcustomerDrawerClose(): void {
        this._changeDetectorRef.markForCheck();
        this.getOldVisitors();

        var d = document.getElementById('addCustomerDrawer') as HTMLElement;
        d.click();
    }

    get newcustomerDrawerCloseCallback() {
        return this.newcustomerDrawerClose.bind(this);
    }
    ...
    updateAllComplete(event, i) {
        ...
        this.customersTableColumns2[i].SHOW = event;
        this.customerTableColumns = ['checkbox', 'ACTION', 'NAME'];

        this.customersTableColumns2.forEach((item) => {
            if (item.SHOW == true) {
